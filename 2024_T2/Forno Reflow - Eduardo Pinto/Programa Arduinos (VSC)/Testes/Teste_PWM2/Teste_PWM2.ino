...
void setup_PWM(uint8_t pwm_driver1, uint8_t pwm_driver2, uint8_t pwm_driver3, uint8_t pwm_driver4, uint8_t pwm_buzzer ) {
...
//Configure the pin C.2  as PWML0 Set-up (PIN34)
  ...
  PWM->PWM_CH_NUM[0].PWM_CDTY = pwm_driver1;                   // Channel 0: Set the PWM duty cycle to x%= (CDTY/ CPRD)  * 100 % ;
...
//Configure the pin C.4  as PWML1 Set-up (PIN36)
  ...
  PWM->PWM_CH_NUM[1].PWM_CDTY = pwm_driver2;                   // Channel 1: Set the PWM duty cycle to x%= (CDTY/ CPRD)  * 100 % ;
...
//Configure the pin C.6  as PWML2 Set-up (PIN38)
  ...
  PWM->PWM_CH_NUM[2].PWM_CDTY =pwm_driver3;                   // Channel 2: Set the PWM duty cycle to x%= (CDTY/ CPRD)  * 100 % ;
  ...
  PWM->PWM_CH_NUM[3].PWM_CDTY = pwm_driver4;                   // Channel 3: Set the PWM duty cycle to x%= (CDTY/ CPRD)  * 100 % ;
  ...
  PWM->PWM_CH_NUM[5].PWM_CDTY = pwm_buzzer;             // Channel 5: Set the PWM duty cycle to x%= (CDTY/ CPRD)  * 100 % ;
...
void setup () {
  ...
  setup_PWM(10,25,50,75,50);  // Configure the 
